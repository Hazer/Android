...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("LittleWeebAndroid.MainActivity+MyWebChromeClient, LittleWeeb", MainActivity_MyWebChromeClient.class, __md_methods);
	}
	...
	public MainActivity_MyWebChromeClient ()
	{
		...
		if (getClass () == MainActivity_MyWebChromeClient.class)
			mono.android.TypeManager.Activate ("LittleWeebAndroid.MainActivity+MyWebChromeClient, LittleWeeb", "", this, new java.lang.Object[] {  });
	}
